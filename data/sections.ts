export interface Section {
  ...
  export const sections: Section[] = [
    ...
    { title: 'AI is a trasformative technology. We put it to work for you.', content: 'We develop algorithms that free up your time to do your best work. Automate small, manual tasks that take time to spend time on what matters: running your business.' },
    ...
    { title: 'Our Work', content: 'From migration analytics to forecasting, we build for impact.' },
